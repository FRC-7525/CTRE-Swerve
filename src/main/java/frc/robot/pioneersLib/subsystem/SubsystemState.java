...
public record SubsystemState(
    ...
    */
    public static SubsystemState fromElevatorStates(String stateString, Measure<DistanceUnit> position, Measure<LinearVelocityUnit> velocity) {
     ...
     */
    public static SubsystemState fromOpeningIntakeStates(String stateString, Rotation2d angularPosition, Measure<AngularVelocityUnit> angularVelocity) {
     ...
     * Static factory method for defining a subsystem with just intake states
     */
    public static SubsystemState fromIntakeStates(String stateString, Measure<AngularVelocityUnit> angularVelocity) {
    ...
    */
    public static SubsystemState fromFlywheelStates(String stateString, Measure<AngularVelocityUnit> velocity) {
    ...
    */
    public static SubsystemState fromUnevenFlywheelStates(String stateString, Measure<AngularVelocityUnit> velocity, Measure<AngularVelocityUnit> secondaryVelocity) {
     ...
     */
    public static SubsystemState fromPivotWithSpinnerStates(String stateString, Rotation2d angularPosition, Measure<AngularVelocityUnit> angularVelocity) {
        return new SubsystemState(stateString, null, angularPosition, null, angularVelocity, null, null);
    }  
    ...
    */
    public static SubsystemState fromTurettStates(String stateString, Rotation2d angularPosition, Measure<AngularVelocityUnit> angularVelocity) {
        return new SubsystemState(stateString, null, angularPosition, null, angularVelocity, null, null);
    }
